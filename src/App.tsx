        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <div className="flex gap-2">
            <select 
              ...
              className="border border-gray-300 rounded-lg px-3 py-2 dark:bg-gray-800 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
